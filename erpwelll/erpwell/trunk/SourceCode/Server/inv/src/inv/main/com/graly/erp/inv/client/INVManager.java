...
public List<Material> queryMaterialQtysAlarmYn(Long orgRrn,String whereClause,String whereClause2,String whereClause3) throws ClientException;
    ...
    //2018.6.24 生产入库扫码入库
     Lot getSweepStorageLot(String Lot)throws ClientException;
     MovementIn saveMovementLotLine(MovementIn in, List<MovementLine> lines, MovementIn.InType inType, long userRrn,long orgRrn) throws ClientException;
