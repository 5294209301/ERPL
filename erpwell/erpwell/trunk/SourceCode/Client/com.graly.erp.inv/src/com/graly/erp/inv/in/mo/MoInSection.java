...
public class MoInSection extends MasterSection {
	...
	protected ToolItem itemSweepStorage;
	...
	public void createToolBar(Section section) {
		...
		createToolItemitemSweepStorage(tBar);
	...
	protected void createToolItemitemSweepStorage(ToolBar tBar) {
		itemSweepStorage = new ToolItem(tBar, SWT.PUSH);
		itemSweepStorage.setText("批次入库");
		itemSweepStorage.setImage(SWTResourceCache.getImage("barcode"));
		itemSweepStorage.addSelectionListener(new SelectionAdapter() {
			@Override
	...
	protected void sweepStorage() {
		// TODO Auto-generated method stub
		MoLLotOutDialog olbd = new MoLLotOutDialog(UI.getActiveShell());
