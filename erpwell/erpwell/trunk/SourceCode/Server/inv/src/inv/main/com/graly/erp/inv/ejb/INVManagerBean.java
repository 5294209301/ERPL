...
//				m.setTotalPrice(totalPrice);
	...
	@Override
	public Lot getSweepStorageLot(String Lot) throws ClientException {
		// TODO Auto-generated method stub
		if(Lot !=null && !Lot.equals("")){
			StringBuffer hql = new StringBuffer("");
			hql.append(" from Lot lot where  lot.isActive = 'Y' and lot.lotId = '"+Lot+"' ");
			Query query = em.createQuery(hql.toString());
			List<Lot> lots = query.getResultList();
	...
	public MovementIn saveMovementLotLine(MovementIn in, List<MovementLine> lines, MovementIn.InType inType, long userRrn,long orgRrn) throws ClientException {
		try {
			if (in.getObjectRrn() == null) {
				in.setIsActive(true);
				in.setCreatedBy(userRrn);
